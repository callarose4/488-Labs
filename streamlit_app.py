...
lab9_page = st.Page("Labs/Lab9.py", title="Lab 9", default=True)

pg = st.navigation([lab1_page, lab2_page, lab3_page, lab4_page, lab5_page, lab6_page, lab7_page, lab8_page, lab9_page])
pg.run()