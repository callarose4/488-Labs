...
lab6_page = st.Page("Labs/Lab6.py", title="Lab 6", default=True)
lab7_page = st.Page("Labs/Lab7.py", title="Lab 7", default=True)

pg = st.navigation([lab1_page, lab2_page, lab3_page, lab4_page, lab5_page, lab6_page, lab7_page])
pg.run()